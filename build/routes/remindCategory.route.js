...
router.get('/get-all', remindCategory_controller_1.default.getAllRows);
router.get('/get-all/by-user', verifyToken_middleware_1.verifyToken, remindCategory_controller_1.default.getByUserId);
router.post('/add', [(0, express_validator_1.body)("name", msg_constant_1.default.NOT_EMPTY)
        .isString()
    ...
    (0, express_validator_1.body)("icon", msg_constant_1.default.NOT_EMPTY)
        .isString()
        .withMessage(msg_constant_1.default.VALIDATE_DATA)], verifyToken_middleware_1.verifyToken, remindCategory_controller_1.default.addCategory);
exports.default = (app) => {
