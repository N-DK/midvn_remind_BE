...
class RemindModel extends database_model_1.default {
    ...
    getAll(con, userID) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this.selectWithJoins(con, tableName_constant_1.tables.tableVehicleNoGPS, `${tableName_constant_1.tables.tableVehicleNoGPS}.id AS vehicle_id,
               ...
               ${tableName_constant_1.tables.tableRemindCategory}.is_deleted AS category_is_deleted`, `${tableName_constant_1.tables.tableVehicleNoGPS}.user_id = ? AND ${tableName_constant_1.tables.tableVehicleNoGPS}.is_deleted = 0`, [userID], [
                {
    ...
    getByVehicleId(con, vehicleID) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this.selectWithJoins(con, tableName_constant_1.tables.tableVehicleNoGPS, `${tableName_constant_1.tables.tableVehicleNoGPS}.id AS vehicle_id,
                 ...
                 ${tableName_constant_1.tables.tableRemindCategory}.create_time AS category_create_time,
                 ${tableName_constant_1.tables.tableRemindCategory}.update_time AS category_update_time,
                 ${tableName_constant_1.tables.tableRemindCategory}.is_deleted AS category_is_deleted`, `${tableName_constant_1.tables.tableVehicleNoGPS}.license_plate = ? AND ${tableName_constant_1.tables.tableVehicleNoGPS}.is_deleted = 0`, [vehicleID], [
                {
                    table: tableName_constant_1.tables.tableRemindVehicle,
                    on: `${tableName_constant_1.tables.tableVehicleNoGPS}.license_plate = ${tableName_constant_1.tables.tableRemindVehicle}.vehicle_id`,
                    type: 'LEFT',
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const payload = {
                    ...
                    cumulative_kilometers: (_e = data === null || data === void 0 ? void 0 : data.cumulative_kilometers) !== null && _e !== void 0 ? _e : 0,
                    expiration_time: (_f = data === null || data === void 0 ? void 0 : data.expiration_time) !== null && _f !== void 0 ? _f : 0,
                    is_deleted: 0,
                    km_before: (_g = data === null || data === void 0 ? void 0 : data.km_before) !== null && _g !== void 0 ? _g : INFINITY,
                    is_notified: (_h = data === null || data === void 0 ? void 0 : data.is_notified) !== null && _h !== void 0 ? _h : 0,
                    is_received: (_j = data === null || data === void 0 ? void 0 : data.is_received) !== null && _j !== void 0 ? _j : 0,
                ...
                const remind = Object.assign(Object.assign({}, payload), { remind_id, vehicles: (_k = data === null || data === void 0 ? void 0 : data.vehicles) !== null && _k !== void 0 ? _k : [] });
                ...
                const values = (_l = data === null || data === void 0 ? void 0 : data.schedules) === null || _l === void 0 ? void 0 : _l.map((schedule) => `(${remind_id}, ${schedule.start}, ${schedule.end}, '${schedule.time}', ${Date.now()})`).join(',');
    ...
    scheduleCronJobForExpiration(remind) {
        return __awaiter(this, void 0, void 0, function* () {
            const cronJob = yield schedule_util_1.default.createCronJobForExpired(new Date(remind.expiration_time * 1000 + 86400000), remind);
            cronJob.start();
        });
    }
    ...
    updateRemind(con, data, remindID) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const result = yield this.update(con, tableName_constant_1.tables.tableRemind, {
                img_url: (_a = data === null || data === void 0 ? void 0 : data.img_url) !== null && _a !== void 0 ? _a : null,
                note_repair: (_b = data === null || data === void 0 ? void 0 : data.note_repair) !== null && _b !== void 0 ? _b : null,
                history_repair: (_c = data === null || data === void 0 ? void 0 : data.history_repair) !== null && _c !== void 0 ? _c : null,
                current_kilometers: (_d = data === null || data === void 0 ? void 0 : data.current_kilometers) !== null && _d !== void 0 ? _d : 0,
                cumulative_kilometers: (_e = data === null || data === void 0 ? void 0 : data.cumulative_kilometers) !== null && _e !== void 0 ? _e : 0,
                expiration_time: (_f = data === null || data === void 0 ? void 0 : data.time_expire) !== null && _f !== void 0 ? _f : 0,
                time_before: (_g = data === null || data === void 0 ? void 0 : data.time_before) !== null && _g !== void 0 ? _g : INFINITY,
                is_notified: (_h = data === null || data === void 0 ? void 0 : data.is_notified) !== null && _h !== void 0 ? _h : 0,
                is_received: (_j = data === null || data === void 0 ? void 0 : data.is_notified) !== null && _j !== void 0 ? _j : 0,
                update_time: Date.now(),
            }, 'id', remindID);
            const isRedisReady = redis_model_1.default.redis.instanceConnect.isReady;
            if (isRedisReady) {
                yield redis_model_1.default.hSet('remind', remindID, JSON.stringify(result), 'remind.models.ts', Date.now());
            }
            return result;
        });
    }
    search(con, userID, query) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let whereClause = `${tableName_constant_1.tables.tableVehicleNoGPS}.user_id = ? ${query.vehicle_id
                ...
                : ''} AND ${tableName_constant_1.tables.tableVehicleNoGPS}.is_deleted = 0 AND 
            (
            ...
            const result = yield this.selectWithJoins(con, tableName_constant_1.tables.tableVehicleNoGPS, `${tableName_constant_1.tables.tableVehicleNoGPS}.license_plate AS license_plate,
               ...
               ${tableName_constant_1.tables.tableRemindCategory}.create_time AS category_create_time,
               ${tableName_constant_1.tables.tableRemindCategory}.update_time AS category_update_time,
               ${tableName_constant_1.tables.tableRemindCategory}.is_deleted AS category_is_deleted`, whereClause, params, [
                {
                    table: tableName_constant_1.tables.tableRemindVehicle,
                    on: `${tableName_constant_1.tables.tableVehicleNoGPS}.license_plate = ${tableName_constant_1.tables.tableRemindVehicle}.vehicle_id`,
                    type: 'LEFT',
