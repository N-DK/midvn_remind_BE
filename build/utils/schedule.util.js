...
class ScheduleUtils {
    ...
    restoreCronJobsForExpired() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (
                !(reminds === null || reminds === void 0
                    ? void 0
                    : reminds.length)
            )
                return;
            for (const remind of reminds) {
                const expirationTime = new Date(remind.expiration_time);
                console.log('expirationTime', expirationTime);
                const cronJob = yield this.createCronJobForExpired(
                    expirationTime,
                    remind,
                );
                cronJob.start();
    ...
    createCronJobForExpired(expirationTime, remind) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { remind_id, vehicles, id } = remind,
                other = __rest(remind, ['remind_id', 'vehicles', 'id']);
            console.log('other', other);
            console.table({ remind: remind.remind_id, month, day });
            const cronJob = node_cron_1.default.schedule(
                `* * ${day} ${month} *`, // */20 8-20
                () =>
                    __awaiter(this, void 0, void 0, function* () {
                        try {
                            yield this.databaseModel.update(
                                this.conn,
                            ...
                            yield this.databaseModel.insert(
                                this.conn,
                                tableName_constant_1.tables.tableRemind,
                                Object.assign(Object.assign({}, other), {
    ...
    restoreCronJobs() {
        if (
            !(schedules === null || schedules === void 0
                ? void 0
                : schedules.length)
        )
            return;
        for (const { remind, schedule } of schedules) {
            const cronJob = this.createCronJob(schedule, remind, () =>
                __awaiter(this, void 0, void 0, function* () {
                    yield notify_services_1.remindFeature.sendNotifyRemind(
                        'http://localhost:3007',
                        {
    ...
    loadReminds() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (!isRedisReady) {
                    const results = yield this.databaseModel.select(
                        this.conn,
                        tableName_constant_1.tables.tableRemind,
                        '*',
                    ...
                    return yield Promise.all(
                        results.map((item) =>
                            __awaiter(this, void 0, void 0, function* () {
                                ...
                                return (yield this.buildSchedule(
                                    item,
                                    this.conn,
                                )).remind;
                            }),
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const isRedisReady =
                    redis_model_1.default.redis.instanceConnect.isReady;
                if (!isRedisReady) {
                    const result = yield this.databaseModel.selectWithJoins(
                        this.conn,
                        tableName_constant_1.tables.tableRemindSchedule,
                        '*',
                    ...
                    schedules = yield Promise.all(
                        result.map((item) =>
                            __awaiter(this, void 0, void 0, function* () {
                                return this.buildSchedule(item, this.conn);
                            }),
                        ),
                    );
                } else {
                    const result = yield redis_model_1.default.get(
                        'schedules',
                        'schedule.util.ts',
                        Date.now(),
                    );
    ...
    buildSchedule(item, conn) {
        return __awaiter(this, void 0, void 0, function* () {
            const vehicles = yield this.databaseModel.selectWithJoins(
                conn,
            ...
            return {
                remind: Object.assign(Object.assign({}, item), {
                    vehicles: vehicles.map((v) => v.license_plate),
                }),
                schedule: {
    ...
    isValidDateRange(currentDate, start, end) {
        return (
            !(0, date_fns_1.isBefore)(currentDate, start) &&
            !(0, date_fns_1.isAfter)(currentDate, end)
        );
    }
            ...
            () =>
                __awaiter(this, void 0, void 0, function* () {
                    ...
                    try {
                        ...
                        console.error(
                            'Error during cron job execution:',
                            error,
                        );
                    }
                }),
    ...
    updateSchedulesInRedis() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (isRedisReady) {
                try {
                    yield redis_model_1.default.set(
                        'schedules',
